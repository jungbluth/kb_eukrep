...
class kb_eukrep:
    ...
    ######################################### noqa
    VERSION = "1.0.0"
    GIT_URL = "https://github.com/jungbluth/kb_eukrep"
    ...
    def run_kb_eukrep(self, ctx, params):
        """
        :param params: instance of type "EukrepInputParams" (required
        ...
        :returns: instance of type "EukrepResult" (result_folder: folder
           path that holds all files generated by run_kb_eukrep report_name:
        ...
        eukrep_runner = EukrepUtil(self.config)

        returnVal = eukrep_runner.run_eukrep(params)

        #END run_kb_eukrep

        # At some point might do deeper type checking...
        if not isinstance(returnVal, dict):
            raise ValueError('Method run_kb_eukrep return value ' +
